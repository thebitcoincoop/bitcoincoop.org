...
curl "http://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20yahoo.finance.xchange%20where%20pair%20in%20%28%22USDCAD%22,%20%22CADUSD%22%29&env=store://datatables.org/alltableswithkeys" > $DIR/usd_cad.xml.tmp && mv $DIR/usd_cad.xml.tmp $DIR/usd_cad.xml